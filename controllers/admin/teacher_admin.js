...
// Just sending admin/edit-teacher view with editing=false.
exports.getAddTeacher = (req, res, next) => {
  //"admin/teacher/edit-teacher"
  res.send({
...
// Just sending all the teachers , fetched from DB.
...
// edit=true has been set on admin/teachers edit link. Then it sends /admin/edit-teacher view.
